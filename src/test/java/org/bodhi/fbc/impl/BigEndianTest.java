...
public class BigEndianTest {
    ...
    public void testInt2() {
        assertGetInt2(0x0102, 1, 2);
        assertGetInt2(-1, xFF, xFF);

        assertPutInt2(0x0102, 1, 2);
        assertPutInt2(-1, xFF, xFF);
    }

    @Test
    public void tesUInt2() {
        assertGetUInt2(0x0102, 1, 2);
        assertGetUInt2(0xffff, xFF, xFF);

        assertPutUInt2(0x0102, 1, 2);
        assertPutUInt2(0xffff, xFF, xFF);
    }
    ...
    {
        assertEquals(expected, m_endian.getUtfChar(toBytes(b1, b2), 0));
    }
    ...
    private void assertGetInt2(int expected, int b1, int b2)
    {
        assertEquals(expected, m_endian.getInt2(toBytes(b1, b2), 0));
    }

    private void assertGetUInt2(int expected, int b1, int b2)
    {
        assertEquals(expected, m_endian.getUInt2(toBytes(b1, b2), 0));
    }

    private void assertPutInt2(int expected, int b1, int b2)
    {
    ...
    private void assertPutUInt2(int expected, int b1, int b2)
    {
        ...
        m_endian.putUInt2(raw, 0, expected);
        assertArrayEquals(toBytes(b1, b2), raw);
    }
    ...
    private void assertGetInt4(int expected,
                                  ...
                                  int b4)
    {
        assertEquals(expected, m_endian.getInt4(toBytes(b1, b2, b3, b4), 0));
    }
    ...
    {
        assertEquals(expected, m_endian.getInt8(toBytes(b1, b2, b3, b4, b5, b6, b7, b8), 0));
    }
